...
export const WhatsAppIcon: React.FC<WhatsAppIconProps> = ({ className = "w-5 h-5" }) => {
  return (
    ...
    >
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 2.159.684 4.158 1.848 5.793L2.5 21.5l3.827-1.312C7.886 21.288 9.87 22 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18c-1.854 0-3.585-.544-5.043-1.481l-.361-.233-2.736.938.943-2.656-.257-.38A7.957 7.957 0 014 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z"/>
    </svg>
  );
};
